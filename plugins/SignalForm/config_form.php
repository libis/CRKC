...
<?php
$reply_from_email = get_option('signal_form_reply_from_email');
$forward_to_email = get_option('signal_form_forward_to_email');	
$admin_notification_email_subject = get_option('signal_form_admin_notification_email_subject');
$admin_notification_email_message_header = get_option('signal_form_admin_notification_email_message_header');
$user_notification_email_subject = get_option('signal_form_user_notification_email_subject');
$user_notification_email_message_header = get_option('signal_form_user_notification_email_message_header');
$contact_page_title = get_option('signal_form_contact_page_title');
$contact_page_instructions = get_option('signal_form_contact_page_instructions');
$thankyou_page_title = get_option('signal_form_thankyou_page_title');
$thankyou_page_message = get_option('signal_form_thankyou_page_message');
$add_to_main_navigation = get_option('signal_form_add_to_main_navigation');
