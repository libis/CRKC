    ...
    public function browseAction()
    {
        ...
        /*if($_GET['info']=='yes'){
        	foreach($results['items'] as $result){
        		if($result->item_type_id == 8 || $result->item_type_id == 17){
        			$resultsNew[] = $result;
        			//var_dump($result->id);
        		}
        		echo $result->item_type_id;
        	}

        	//var_dump($resultsNew);
        	$results['items'] = $resultsNew;
        	$results['total_results'] = sizeof($resultsNew);
        	$results['total_items'] = sizeof($resultsNew);
        	echo sizeof($resultsNew);
